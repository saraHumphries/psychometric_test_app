    ...
    return (
        <div>
            ...
            <div id="likert-buttons">
                <button id="likert-button" value = '1' onClick = {onLikertButtonClick}>disagree</button>
                <button id="likert-button" value = '2' onClick = {onLikertButtonClick}>slightly disagree</button>
                <button id="likert-button" value = '3' onClick = {onLikertButtonClick}>neither disagree or agree</button>
                <button id="likert-button" value = '4' onClick = {onLikertButtonClick}>slightly agree</button>
                <button id="likert-button" value = '5' onClick = {onLikertButtonClick}>agree</button>
            </div>
            : null}
